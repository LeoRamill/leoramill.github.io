...
| Foto profilo | `content/authors/admin/avatar.png` |
| Foto di copertina | `assets/media/cover.jpg` |
| Sezioni della home (ordine, sfondi, testi) | `content/_index.md` |
| News (una per file) | `content/news/*.md` |
| Pubblicazioni (una cartella per paper) | `content/publication/*/index.md` |
| Progetti | `content/project/*/index.md` |
| Pagina CV | `content/cv/index.md` e PDF in `static/uploads/CV.pdf` |
